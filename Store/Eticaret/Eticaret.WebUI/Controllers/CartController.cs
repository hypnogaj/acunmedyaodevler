...
namespace NetCoreUrunSitesi.Controllers
{
    public class CartController : Controller
    {
        ...
        public CartController(IService<Product> productService, IService<AppUser> service, IService<Eticaret.Core.Entities.Address> serviceAddress, IService<Order> serviceOrder, IConfiguration configuration)
        {
